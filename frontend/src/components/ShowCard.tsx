...
export default function ShowCard({ show, venueName, companyName, watchStatus, onWatchChange, extraDates }: Props) {
  ...
  return (
    <div className="relative w-full text-left bg-white border border-neutral-100 rounded-xl flex items-stretch hover:border-neutral-300 transition-colors group dutch:bg-white dutch:border-[#ece7de] dutch:hover:border-[#d4c9b8]">
      ...
      >
        ...
        {show.image_url ? (
          ...
          <div className="w-12 md:w-20 border border-neutral-200 rounded-lg flex items-center justify-center flex-shrink-0 text-neutral-400 group-hover:text-neutral-600 transition-colors dutch:border-[#ece7de] dutch:text-[#888]" style={{ aspectRatio: "4/3" }}>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="font-serif text-sm md:text-base font-medium text-neutral-900 md:truncate line-clamp-2 md:line-clamp-none dutch:text-[#1a1a1a]">{show.title}</span>
          </div>
          {show.subtitle && (
        ...
        <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
          <div className="text-xs text-neutral-400 dutch:text-[#888]">{day} {monthShort}</div>
          {show.time && (
      ...
      <div className="relative flex-shrink-0 flex items-center pr-3">
        <button
          ...
          className="p-1 rounded-lg hover:bg-neutral-100 transition-colors dutch:hover:bg-[#ece7de]"
        >
          {isWatched ? (
